...
public class ErrorConstant {
  ...
  public static final String OFFICE_NOT_FOUND_MESSAGE = "La sucursal no existe";
  ...
  public static final String PARAMETER_NOT_FOUND_MESSAGE = "El Parámetro no existe";
  ...
  public static final String UNIT_NOT_FOUND_MESSAGE = "La unidad de medida no existe";
